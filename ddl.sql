...
create table comments (id  bigserial not null, version int8 not null, guid varchar(255), body text not null, post_id int8 not null, email varchar(255) not null, name varchar(255) not null, date_created timestamp not null, url varchar(255) not null, date_updated timestamp not null, primary key (id));
create table posts (id  bigserial not null, version int8 not null, body text not null, last_updated timestamp not null, guid varchar(64), author varchar(128), title varchar(255) not null, comments_closed bool, permalink varchar(255), allow_comments bool, date_created timestamp not null, primary key (id));
